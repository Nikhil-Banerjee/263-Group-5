...
jun2012 = datetime.datetime(2012, 6, 30)
# Joining exp3 dfs
...
# ax2[0].plot(dfs2merged['date'], dfs2merged['steam rate (t/d)'], marker = 'o', linestyle = 'none', markeredgecolor = '#EACE09' ,fillstyle = 'none' ,label = 'Steam Rate (t/d)')
# ax2[0].set_ylabel("Steam Rate (t/d)", color = "#EACE09")
# ax2[0].spines['left'].set_color('#EACE09')
...
# ax2twin1.plot(dfs2merged['date'], dfs2merged['oil rate (m^3/day)'], 'yo', label = 'oil rate (m^3/day)')

# ax2[2].plot(dfs2merged['date'], dfs2merged['pressure (kPa)'], 'g-', label = 'pressure (kPa)')
# ax2twin2 = ax2[2].twinx()
# ax2twin2.plot(dfs2merged['date'], dfs2merged['temperature (degC)'], 'r-', label = 'Temperature (°C)')
...
ax2[0].plot(dfs2merged['date'], dfs2merged['steam rate (t/d)'], marker = 'o', linestyle = 'none', markeredgecolor = 'black' ,fillstyle = 'none' ,label = 'Steam Rate (t/d)')
ax2[0].set_ylabel('Steam Rate (t/d)')
ax2[0].legend()


l2_1a = ax2[1].plot(dfs2merged['date'], dfs2merged['water rate (m^3/day)'], marker = '^', linestyle = 'none', markeredgecolor = waterCol, fillstyle = 'none', label = 'Water Rate (m^3/day)')
ax2[1].set_ylabel("Water Rate (m^3/day)", color = waterCol)
ax2[1].spines['left'].set_color(waterCol)
ax2[1].tick_params(axis='y', colors = waterCol)
ax2[1].title.set_color(waterCol)

ax2twin1 = ax2[1].twinx()
l2_1b = ax2twin1.plot(dfs2merged['date'], dfs2merged['oil rate (m^3/day)'], marker = '^', linestyle = 'none', markeredgecolor = oilCol, fillstyle = 'none',label = 'oil rate (m^3/day)')
ax2twin1.set_ylabel("Oil Rate (m^3/day)", color = oilCol)
ax2twin1.spines['right'].set_color(oilCol)
...
ax2[2].spines['left'].set_color(pressureCol)
...
ax2twin2.spines['right'].set_color(tempCol)
...
ax3[0].plot(dfs3merged['date'], dfs3merged['steam rate (t/d)'], marker = 'o', linestyle = 'none', markeredgecolor = 'black' ,fillstyle = 'none' ,label = 'Steam Rate (t/d)')
ax3[0].set_ylabel('Steam Rate (t/d)')
ax3[0].legend()


l3_1a = ax3[1].plot(dfs3merged['date'], dfs3merged['water rate (m^3/d)'], marker = '^', linestyle = 'none', markeredgecolor = waterCol, fillstyle = 'none', label = 'Water Rate (m^3/day)')
ax3[1].set_ylabel("Water Rate (m^3/day)", color = waterCol)
ax3[1].spines['left'].set_color(waterCol)
ax3[1].tick_params(axis='y', colors = waterCol)
ax3[1].title.set_color(waterCol)

ax3twin1 = ax3[1].twinx()
l3_1b = ax3twin1.plot(dfs3merged['date'], dfs3merged['oil rate (m^3/d)'], marker = '^', linestyle = 'none', markeredgecolor = oilCol, fillstyle = 'none',label = 'oil rate (m^3/day)')
ax3twin1.set_ylabel("Oil Rate (m^3/day)", color = oilCol)
ax3twin1.spines['right'].set_color(oilCol)
...
ax3[2].spines['left'].set_color(pressureCol)
...
ax3twin2.spines['right'].set_color(tempCol)
